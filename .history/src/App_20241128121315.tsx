...
const App: React.FC = () => {
  ...
  return (
    <div>
      ...
      {/* Modal 1: Header with one button, footer with two buttons */}
      {currentModal === 'modal1' && (
        <Modal
          title="Dialog 1"
          icon={<span>📄</span>}
      ...
      {/* Modal 2: Header with two buttons, footer without buttons */}
      {currentModal === 'modal2' && (
        <Modal
          title="Dialog 2"
          icon={<span>⚙️</span>}
      ...
      {/* Modal 3: No header buttons, footer with one button */}
      {currentModal === 'modal3' && (
        <Modal
          title="Dialog 3"
